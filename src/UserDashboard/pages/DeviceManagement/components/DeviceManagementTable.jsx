...
const tableDataPlaceholder = [
  {
    id: 1,
    devEui: "A1B2C3D4E5F6G7H8",
    deviceName: "Device Alpha",
    deviceType: "Wandthermostat",
    building_floor_string: "Building A - Floor 3",
    roomName: "Room 302",
    lastSeen: Date.now() - 3600 * 1000, // 1 hour ago
    batteryLevel: "medium",
    status: "online",
    ...
    movementDetected: "No",
    error: null,
    timestamp: Date.now() - 3600 * 1000, // Last data packet
  },
  {
    id: 2,
    devEui: "H8G7F6E5D4C3B2A1",
    deviceName: "Device Beta",
    deviceType: "Heizthermostat",
    building_floor_string: "Building B - Floor 2",
    roomName: "Room 204",
    lastSeen: Date.now() - 7200 * 1000, // 2 hours ago
    batteryLevel: "high",
    status: "offline",
    targetTemperature: 20,
    currentTemperature: 19.5,
    currentHumidity: 50,
    valvePositionInPercent: 80,
    childLock: true,
    error: null,
  ...
  },
  {
    ...
    deviceType: "Type C",
    building_floor_string: "Building C - Floor 1",
    roomName: "Room 101",
    lastSeen: Date.now() - 1800 * 1000, // 30 minutes ago
    batteryLevel: "low",
    status: "online",
    openClose: "Closed",
    error: "Low battery",
    ...
    <div className="flex flex-col w-full gap-4">
      <div className="relative w-full overflow-x-auto bg-white shadow-md sm:rounded-lg">
        ...
        <table className="w-full text-sm text-left text-gray-500 rtl:text-right dark:text-gray-400">
          ...
          <tbody>
            {tableDataPlaceholder?.length > 0 &&
              tableDataPlaceholder.map((item, index) => (
