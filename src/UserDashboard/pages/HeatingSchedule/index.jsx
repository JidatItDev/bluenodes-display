...
function HeatingSchedulePage() {
  ...
  const placeholderPrograms = [
    {
      templateName: "Standard Programm",
      assignedRooms: 3,
      allowDeviceOverride: true,
      deviceOverrideTemperatureMin: 18,
      deviceOverrideTemperatureMax: 24,
    },
    {
      templateName: "Winter Heizplan",
      assignedRooms: 5,
      allowDeviceOverride: false,
      deviceOverrideTemperatureMin: null,
      deviceOverrideTemperatureMax: null,
    },
    {
      templateName: "Sommer Kühlplan",
      assignedRooms: 2,
      allowDeviceOverride: true,
      deviceOverrideTemperatureMin: 20,
