...
function MainPage() {
  ...
  const placeholderStatsData = {
    numberOfDevices: 100,
    numberOfDevicesOffline: 10,
    numberOfErrors: 5,
    numberOfRooms: 50,
    unassignedNumberOfRooms: 8,
  };

  const [statsData, setStatsData] = useState(placeholderStatsData);
  ...
  const fetchData = async () => {
    try {
      ...
      // Use placeholder data instead of API response
      setStatsData(placeholderStatsData);
      setDataLoaded(true);
    } catch (error) {
      console.error("Failed to fetch stats:", error);
    }
        ...
        {activeCard === "generalError" && (
          <ErrorLogsTable
            placeholdertableData={[
              {
                roomName: "Raum A101",
                building_floor_string: "Gebäude 1 - 1. Etage",
                createdAt: "2025-01-06T12:00:00Z",
                eventTypeLevel: "Information",
                eventTypeMessage: "Keine Probleme",
                message: "Alles funktioniert einwandfrei.",
              },
              {
                roomName: "Raum B202",
                building_floor_string: "Gebäude 2 - 2. Etage",
                createdAt: "2025-01-05T14:30:00Z",
                eventTypeLevel: "Warning",
                eventTypeMessage: "Licht aus",
                message: "Das Licht in Raum B202 ist ausgeschaltet.",
              },
              {
                roomName: "Raum C303",
                building_floor_string: "Gebäude 3 - 3. Etage",
                createdAt: "2025-01-04T08:15:00Z",
                eventTypeLevel: "Behoben",
                eventTypeMessage: "Fehler behoben",
                message: "Der Fehler wurde erfolgreich behoben.",
              },
              {
                roomName: "Raum D404",
                building_floor_string: "Gebäude 4 - 4. Etage",
                createdAt: "2025-01-03T16:45:00Z",
                eventTypeLevel: "Error",
                eventTypeMessage: "Kritischer Fehler",
                message: "Es gibt einen kritischen Fehler im Raum D404.",
              },
            ]}
          />
        )}
